...
PM_AREA_COMPLIANCE="{{OPT_AREA_DESIGN}}"
PM_AREA_GROWTH="{{OPT_AREA_DOCS}}"
PM_AREA_DATA="{{OPT_AREA_PM}}"

# Issue Type option IDs
PM_TYPE_EPIC="{{OPT_TYPE_BUG}}"
PM_TYPE_FEATURE="{{OPT_TYPE_FEATURE}}"
PM_TYPE_BUG="{{OPT_TYPE_SPIKE}}"
PM_TYPE_CHORE="{{OPT_TYPE_EPIC}}"
PM_TYPE_SPIKE="{{OPT_TYPE_CHORE}}"

# Risk option IDs
PM_RISK_LOW="{{OPT_RISK_LOW}}"
PM_RISK_MED="{{OPT_RISK_MEDIUM}}"
